                ...
                <div class="course-one__single">
                    ...
                    <div class="course-one__content">
                        <div class="course-one__admin">
                            ...
                            by <nuxt-link to="/teacher-details">Demo</nuxt-link>
                        </div><!-- /.course-one__admin -->
                        <h2 class="course-one__title"><nuxt-link to="/course-details">Badge Sample</nuxt-link></h2>
                        <!-- /.course-one__title -->
            ...
            <div class="col-lg-4">
                <div class="course-one__single">
                    ...
                    <div class="course-one__content">
                        ...
                        <h2 class="course-one__title"><nuxt-link to="/course-details">Badge Sample</nuxt-link>
                        </h2>
                        <!-- /.course-one__title -->
                        <div class="course-one__meta">
                            <nuxt-link to="/course-details">$18</nuxt-link>
