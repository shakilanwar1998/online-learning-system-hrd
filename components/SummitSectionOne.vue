    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 clearfix">
                <img src="/assets/images/about.png" class="cta-three__image" alt="">
            </div><!-- /.col-lg-6 -->
            <div class="col-lg-6">
                <div class="cta-three__content">
                    <div class="block-title text-left">
                        <h2 class="block-title__title">About The Summit</h2><!-- /.block-title__title -->
                    </div><!-- /.block-title -->
                    ...
                    <div class="cta-three__single-wrap">
                        <div class="cta-three__single">
                            ...
                            <p class="cta-three__single-text">Professional Training</p><!-- /.cta-three__single-text -->
                        ...
                        <div class="cta-three__single">
                            ...
                            <p class="cta-three__single-text">Expert
                                Speaker</p><!-- /.cta-three__single-text -->
                        </div><!-- /.cta-three__single -->
